    ...
    <Content>
        ...
        <Container>
            <div class="write__wrap">
                ...
                <div class="write__txt__wrap" :class="{'focus' : isFloationBar}">
                    ...
                    <textarea class="text-field" value="포커싱 해보세요.. 플로팅 바가 올라올 겁니다.." @focus="isFloationBar = !isFloationBar" @blur="isFloationBar = !isFloationBar" />
